...
soyk_w = soyk %>%
  ...
  separate(location.k,
                  into = c("location", "k", "pct"),
                  sep = "_") %>%
  select(location, rep, k_rate_kgha, k_pct) %>%
  arrange(location) 
...
Submit your result (take a screenshot that includes the code and the chunk output) on eLC under assignment #2 by Friday Jan 23rd 11:59 pm.
